  ...
  blocks: [
    {
      ...
      text: "So now we know that our layers can be images or videos. What if we want something " +
          ...
          "smaller? This is exactly what shapes are for. Instead of storing the data for " +
          ...
          " needing another file to keep track of.",
    },
    ...
    {
      type: "paragraph",
      text: "This panel is in the left-hand panel stack, so you’ll have to click to expand " +
          "it. Under `Shape Properties`, you’ll find a lot of interesting options depending on the shape. For example, a " +
    ...
    },
    {
      ...
      text: "For making more custom, advanced shapes, there’s the `Pen Tool`. Every shape, even the " +
          "most basic ones, are made up of points and curve values. The pen tool gives you more freedom to  " +
    ...
    },
    {
      ...
      text: "It’s really fun to try to draw these random shapes and you pick it up pretty fast. Pay " +
          "attention to the hotkeys here though, you need them to curve the path. Holding `Alt` while " +
          "clicking on a point gives the point curve handles. Holding `Alt` while clicking on a curve " +
          "handle isolates its curve from the other curve handle."
    },
    {
      type: "component",
      node: <HotkeysGroup hotkeys={[
        { letter: ["OPT", "Click"], label: "Add curve to point." },
        { letter: ["OPT", "Click"], label: "Split curve handles." },
      ]} />,
    },
    ...
    },
    {
      ...
      text: "If you ever collapse that menu, there’s a hotkey to open it back up without clicking " +
          "through all those arrows. This shows the Mask Path which can be animated (see Keyframes)." +
          "Double clicking on `M` will open all mask properties.",
    },
    {
      type: "component",
      node: <HotkeysGroup hotkeys={[
        { letter: "M", label: "Open mask path." },
        { letter: ["M", "M"], label: "Open all mask settings." },
      ]} />,
    },
  ],
};
