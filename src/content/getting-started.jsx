  ...
  blocks: [
    {
      ...
      text: "Starting is always the hardest part. After struggling through learning After Effects " +
          "(which I'll shorten to AE) for the past few years, I've decided to create the resource " +
          "that I wish existed when I'd started. This guide will set you up for more complex " +
          "tutorials. According to the 80/20 rule, you'll do 80% of your work in AE with only 20% of" +
          " the features. I'm going to teach you how to use most of that 20% at a very basic level.",
    },
    {
      type: "paragraph",
      text: "Throughout this website, I'll also include some activities for you. Many of the more " +
          "complex demos will be downloadable project files that you'll have to work on inside AE, " +
          "but there will be a few interactive animations embedded within the website.",
    },
    // {
    //   type: "image",
    ...
    // },
    {
      ...
      text: "Opening After Effects for the very first time, you’ll notice a lot of different boxes," +
          ...
          "different settings and options within these panels. I wouldn’t recommend doing this " +
          "just yet, but these panels are resizable, movable, even closable. If you ever can’t find " +
          "a panel that I or another tutorial uses, all you have to do is go to the " +
          "menu bar at the top and hit `Window`. This should give you a list of all the " +
    ...
    {
      type: "paragraph",
      text: "Your computer's memory (RAM) is an important factor for using AE. As " +
          ...
          "green line can only be as big as your memory allows. While the demos I’ve made should be pretty " +
    ...
    },
    {
      ...
      text: "You should also know about the Disk Cache. When your RAM is full, but AE still needs to" +
          " render more frames, it writes to your Disk Cache, which is in your storage. In AE’s settings, you can adjust " +
          "the amount of space on your computer that you will let AE use for its Disk Cache. In my " +
          "experience, no matter how much RAM you have, this Disk Cache will fill up to its capped size. When it gets full, all you have to do is go into the settings and find `Disk " +
    ...
    { type: "header", text: "Linked Media" },
    {
      ...
      text: "Some of the demos that I’ve provided will use videos and images. Unlike vector-based " +
          ...
          " for the project file to hold onto. Make sure to keep your media in the same " +
          "spot relative to your project file so that After Effects knows where to find it. Whether it’s in " +
          "the same folder or a subfolder to the project file, keep it somewhere safe.",
    },
    {
      type: "image",
      src: missingFootage,
